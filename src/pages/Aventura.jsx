...
function Aventura() {
  ...
  useEffect(() => {
    // Fazendo a solicitação à API do TMDB para filmes de Aventura
    axios.get(`https://api.themoviedb.org/3/discover/movie?api_key=${apiKey}&language=en-US&with_genres=12&page=1`)
      .then(response => {
  ...
  return (
    <div>
      ...
      <MyCarousel />
      <h1 className='h1'>FILMES DE AVENTURA</h1>
