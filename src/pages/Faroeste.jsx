...
function Faroeste() {
  ...
  useEffect(() => {
    // Fazendo a solicitação à API do TMDB para filmes de Faroeste
    axios.get(`https://api.themoviedb.org/3/discover/movie?api_key=${apiKey}&language=en-US&with_genres=37&page=1`)
      .then(response => {
  ...
  return (
    <div>
      ...
      <MyCarousel />
      <h1 className='h1'>FILMES DE FAROESTE</h1>
