...
function Comedia() {
  ...
  useEffect(() => {
    // Fazendo a solicitação à API do TMDB para filmes de Comedia
    axios.get(`https://api.themoviedb.org/3/discover/movie?api_key=${apiKey}&language=en-US&with_genres=35&page=1`)
      .then(response => {
  ...
  return (
    <div>
      ...
      <MyCarousel />
      <h1 className='h1'>FILMES DE COMEDIA</h1>
